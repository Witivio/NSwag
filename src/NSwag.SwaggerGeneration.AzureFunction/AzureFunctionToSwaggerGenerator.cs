...
using NSwag.SwaggerGeneration.AzureFunction.Infrastructure;
...
namespace NSwag.SwaggerGeneration.AzureFunction
{
    ...
    public class AzureFunctionToSwaggerGenerator
    {
        ...
        public AzureFunctionToSwaggerGenerator(AzureFunctionToSwaggerGeneratorSettings settings)
        ...
        public AzureFunctionToSwaggerGenerator(AzureFunctionToSwaggerGeneratorSettings settings, SwaggerJsonSchemaGenerator schemaGenerator)
        {
            Settings = settings;
        ...
        public static IEnumerable<Type> GetControllerClasses(Assembly assembly)
        {
            ...
            return assembly.ExportedTypes
              .Where(t => t.GetTypeInfo().IsAbstract == false)
              .Where(t => t.Name.EndsWith("HttpTrigger"))
              .Where(t =>
              {
                  return t.GetTypeInfo().GetCustomAttributes()
                      .SingleOrDefault(a => a.GetType().Name == "ApiExplorerSettingsAttribute")?
        ...
        public AzureFunctionToSwaggerGeneratorSettings Settings { get; }
        ...
        private async Task<SwaggerDocument> CreateDocumentAsync(AzureFunctionToSwaggerGeneratorSettings settings)
        {
...
namespace NSwag.SwaggerGeneration.AzureFunction
{
    ...
    public class WebApiToSwaggerGenerator
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="WebApiToSwaggerGenerator" /> class.</summary>
        /// <param name="settings">The settings.</param>
        public WebApiToSwaggerGenerator(AzureFunctionToSwaggerGeneratorSettings settings)
            : this(settings, new SwaggerJsonSchemaGenerator(settings))
        {
        }
        ...
        /// <param name="settings">The settings.</param>
        /// <param name="schemaGenerator">The schema generator.</param>
        public WebApiToSwaggerGenerator(AzureFunctionToSwaggerGeneratorSettings settings, SwaggerJsonSchemaGenerator schemaGenerator)
        {
            Settings = settings;
            _schemaGenerator = schemaGenerator;
        }
