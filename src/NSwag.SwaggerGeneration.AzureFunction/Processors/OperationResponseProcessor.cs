...
using NSwag.SwaggerGeneration.AzureFunction.Processors.Models;

namespace NSwag.SwaggerGeneration.AzureFunction.Processors
{
    ...
    {
        private readonly AzureFunctionToSwaggerGeneratorSettings _settings;

        /// <summary>Initializes a new instance of the <see cref="OperationParameterProcessor"/> class.</summary>
        /// <param name="settings">The settings.</param>
        public OperationResponseProcessor(AzureFunctionToSwaggerGeneratorSettings settings)
        {
            _settings = settings;
        }
