...
namespace NSwag.SwaggerGeneration.AzureFunction
{
    ...
    public class AzureFunctionAssemblyToSwaggerGeneratorSettings : AzureFunctionToSwaggerGeneratorSettings
    {
        /// <summary>Initializes a new instance of the <see cref="AzureFunctionAssemblyToSwaggerGeneratorSettings"/> class.</summary>
        public AzureFunctionAssemblyToSwaggerGeneratorSettings()
        {
