...
using NSwag.SwaggerGeneration.AzureFunction.Processors;
...
{
    /// <summary>Settings for the <see cref="AzureFunctionToSwaggerGenerator"/>.</summary>
    public class AzureFunctionToSwaggerGeneratorSettings : JsonSchemaGeneratorSettings
    {
        /// <summary>Initializes a new instance of the <see cref="AzureFunctionToSwaggerGeneratorSettings"/> class.</summary>
        public AzureFunctionToSwaggerGeneratorSettings()
        {
